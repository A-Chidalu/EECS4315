...
(*
    --algorithm getAllSuffixes {
        variable result = input, i = 1, j = 1, dummy = << >>;
       ...
       \* main method
       {
           ...
           (\A l \in 1..Len(result[k]): result[k][l] = input[k - 1 + l])
           );
       } 
    }
*)
\* BEGIN TRANSLATION (chksum(pcal) = "d8283983" /\ chksum(tla) = "a35772a7")
...
Lbl_2 == /\ pc = "Lbl_2"
         /\ IF i <= Len(input)
               ...
               ELSE /\ Assert(       (\A k \in 1..Len(input):
                              ...
                              "Failure of assertion at line 30, column 12.")
                    /\ pc' = "Done"
                    /\ UNCHANGED << j, dummy >>
         /\ UNCHANGED << result, i >>
...
\* Last modified Sun Mar 05 20:38:45 EST 2023 by chiddy00
