...
(*
    --algorithm getAllSuffixes {
       ...
       \* main method
       {
           ...
           (\A l \in k..Len(input): <<input[k..l]>> \in result)
           );
       } 
    }
*)
\* BEGIN TRANSLATION (chksum(pcal) = "176fce10" /\ chksum(tla) = "67af537a")
...
\* Last modified Sun Mar 05 20:11:31 EST 2023 by chiddy00
