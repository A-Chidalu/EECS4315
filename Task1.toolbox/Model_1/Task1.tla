...
(*
    --algorithm Task1{
        ...
        
        {
            ...
            postCondition: assert \A x \in 1..Len(input2): ~(\E y \in 1..Len(output): output[y] = input2[x]);
            
            
        }
    }
*)
\* BEGIN TRANSLATION (chksum(pcal) = "3cb8a7e" /\ chksum(tla) = "289af3a3")
...
postCondition == /\ pc = "postCondition"
                 /\ Assert(\A x \in 1..Len(input2): ~(\E y \in 1..Len(output): output[y] = input2[x]), 
...
\* Last modified Mon Mar 06 17:35:09 EST 2023 by chiddy00
