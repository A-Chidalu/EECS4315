...
(*
    --algorithm isAnagram{
        variable i = 1, j = 0, output = TRUE, found = FALSE;
...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "2fb5d617" /\ chksum(tla) = "5d6f00b")
...
\* Last modified Mon Apr 03 18:36:00 EDT 2023 by chiddy00
