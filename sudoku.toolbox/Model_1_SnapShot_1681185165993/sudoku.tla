...
INV0_1 == (\A a \in 1..N, b \in 1..N:
  board[a][b] # 0 =>
  (\E k, l \in 1..N:
    k # board[a][b] /\ l # board[a][b] /\
    ((a = k) \/ (b = l) \/ ((a-1) % SQRT_N = (k-1) % SQRT_N /\ (b-1) % SQRT_N = (l-1) % SQRT_N)) /\
    board[k][l] = board[a][b]))
...
\* Last modified Mon Apr 10 23:52:27 EDT 2023 by chiddy00
