...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "73043b84" /\ chksum(tla) = "b8c48c43")
...
Lbl_1 == /\ pc = "Lbl_1"
         /\ IF i <= Len(input)
               THEN /\ currNum' = input[i]
                    ...
                    /\ i' = i + 1
                    /\ pc' = "Lbl_1"
               ELSE /\ Assert(\A x \in 1..Len(output): output[x] % 3 = 0, 
...
\* Last modified Mon Mar 06 18:13:28 EST 2023 by chiddy00
